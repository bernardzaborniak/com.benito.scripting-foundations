...
/// </summary>
public class BTransitionExecutorDefaultRequiresPreloadedSceneCoroutine : BTransitionExecuter
{
    // Fades
    ...
    public BTransitionExecutorDefaultRequiresPreloadedSceneCoroutine(MonoBehaviour coroutineHost, Transform sceneManagerTransform, BSceneLoader sceneLoader, GameObject exitCurrentSceneFadePrefab = null, GameObject enterNextSceneFadePrefab = null)
    {
        stage = Stage.Idle;
