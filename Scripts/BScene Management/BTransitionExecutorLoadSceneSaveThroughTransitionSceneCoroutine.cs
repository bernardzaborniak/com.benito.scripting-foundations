...
namespace Benito.ScriptingFoundations.BSceneManagement
{
    ...
    /// </summary>
    public class BTransitionExecutorLoadSceneSaveThroughTransitionSceneCoroutine : BTransitionExecuter
    {
        // Fades
        ...
        public BTransitionExecutorLoadSceneSaveThroughTransitionSceneCoroutine(string targetScene, string transitionScene,
